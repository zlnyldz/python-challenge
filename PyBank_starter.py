...
# Read the data file and process the content
try:
    with open(file_to_load, mode='r') as financial_data:
        ...
        # Initialize values with the first row
...
# Calculate the average change (with a check for empty list to avoid division by zero)
